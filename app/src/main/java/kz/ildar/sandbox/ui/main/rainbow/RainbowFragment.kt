...
class RainbowFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.rainbowItemLiveData.observe(this, Observer { item ->
            val params = rainbowView.getLayoutParams() as ConstraintLayout.LayoutParams
            params.horizontalBias = item.x
            params.verticalBias = item.y
            rainbowView.setLayoutParams(params)
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_rainbow, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        rainbowView.setOnClickListener {
            viewModel.getNewItem()
        }
    }
}